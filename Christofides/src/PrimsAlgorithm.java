...
public class PrimsAlgorithm {
    ...
    int[][] distances;
    SymbolGraph unsortedList;

    public PrimsAlgorithm(SymbolGraph g, int[][] distance) {
        distances = distance;
        unsortedList = g;
    }
...
* */
   public SymbolGraph Run() {
        SymbolGraph mst = new SymbolGraph();
