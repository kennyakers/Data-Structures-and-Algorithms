...
public class Population {
    ...
    public Population(double[][] adjacencyMatrix, Town[] towns, double mutationRate, int num, SymbolGraph.Vertex source) {
    ...
    public void naturalSelection() {
        ...
        if (generation_best.distance < all_time.distance) {
            ...
            System.out.println("New best: " + all_time.distance + " after " + generations + " generations");
            since_change = 0;
        } else {
            since_change++;
        }
